class User < ApplicationRecord
  ...
  # feed (beta)
  # full version will be coming with next chapter
  def feed
  ...
  # return true if current user follows other_user
  ...
  private
    ...
    # use downcase as email address
    def downcase_email
      self.email.downcase!
    end

    # create & set activation token and digest
